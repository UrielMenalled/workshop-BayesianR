...
```{r include=FALSE}
# 1. Tell knitr to physically save the images into the 'KnittedFiles' folder
knitr::opts_knit$set(base.dir = here::here("KnittedFiles"))

# 2. Tell knitr to name the links simply "figures/plot.png"
#    (This creates a relative link: ![](figures/plot.png))
knitr::opts_chunk$set(fig.path = "figures/",
                      echo = TRUE,   # show code
                      results = 'hide', # hide results/output
...
set.seed(123) #Randomization set
```
